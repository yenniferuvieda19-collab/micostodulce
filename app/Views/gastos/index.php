...
<div class="dashboard-container">
    <div class="container px-3 px-md-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold mb-0" style="color: var(--marron-logo);">Mis Costos Indirectos</h2>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?= base_url('gastos/crear') ?>" class="btn btn-primary shadow-sm rounded-pill fw-bold px-4" style="background-color: var(--azul-logo); border:none;">
